////////////////////////////////////////////////////////////////////
//DeRap: FS_2\1_Weapons\m500\config.bin
...
{
	class Mp133Shotgun;
	class FS_m500_ShotgunBase: Mp133Shotgun
	{
		scope = 0;
		absorbency = 0;
	...
	class FS_m500_Shotgun: FS_m500_ShotgunBase
	{
		scope = 2;
		displayName = "MOSSBERG 500 SHOTGUN";
		descriptionShort = "The Mossberg-500 is one of the most common multiple-shot shotguns - pump-action shotguns with a movable forend reloading. First released in 1961. Now it is produced in various modifications designed for both hunting and for police, security guards and self-defense.";
