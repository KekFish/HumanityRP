////////////////////////////////////////////////////////////////////
//DeRap: FS_2\1_SMOT\SidorMask\config.bin
...
class CfgVehicles
{
	...
	class FS_SidorMask_ColorBase: RadarCap_Black
	{
		displayName = "Mask Sidorovich";
		descriptionShort = "Someone got funny, ordered a rubber copy of Sidorovich. ";
	...
	class FS_SidorMask: FS_SidorMask_ColorBase
	{
		scope = 2;
