////////////////////////////////////////////////////////////////////
//DeRap: FS_2\1_Char\Sidor\config.bin
...
class CfgVehicles
{
	...
	class FS_Saharov;
	class FS_Sidor_Char: FS_Saharov
	{
		scope = 2;
		
	};
	class FS_SidorCap_Char: FS_Saharov
	{
		scope = 2;
		
	};
	class FS_Sidor_Base: ZombieMaleBase
	{
		scope = 0;
		hiddenSelections[] = {"vkComFidovPublic"};
		
		displayName = "Sidorovich infected";
	...
	class FS_Sidor_ZMB: FS_Sidor_Base
	{
		scope = 2;
		displayName = "Sidorovich Irradiated";
		descriptionShort = "Infected";
		
	};
	class FS_SidorCap_ZMB: FS_Sidor_Base
	{
		scope = 2;
		hiddenSelections[] = {"vkComFidovPublic"};
		displayName = "Sidorovich Irradiated";
