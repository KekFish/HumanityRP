////////////////////////////////////////////////////////////////////
//DeRap: FS_2\1_Char\clearNebo\config.bin
...
class CfgVehicles
{
	...
	class FS_Saharov;
	class FS_ClearNebo_Char: FS_Saharov
	{
		scope = 2;
	};
	class FS_ClearNebo_Base: ZombieMaleBase
	{
		scope = 0;
	...
	class FS_ClearNebo_ZMB: FS_ClearNebo_Base
	{
		scope = 2;
	};
};
