////////////////////////////////////////////////////////////////////
//DeRap: FS_2\1_Char\shram\config.bin
...
class CfgVehicles
{
	...
	class FS_Saharov;
	class FS_Shram_Char: FS_Saharov
	{
		scope = 2;
		
	};
	class FS_ShramVSS_Char: FS_Saharov
	{
		scope = 2;
		
	};
	class FS_Plash_Zombie_Base: ZombieMaleBase
	{
		scope = 0;
		hiddenSelections[] = {"vkComFidovPublic"};
		
		displayName = "Irradiated Bandit";
	...
	class FS_Plash_Zombie: FS_Plash_Zombie_Base
	{
		scope = 2;
