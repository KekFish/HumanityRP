////////////////////////////////////////////////////////////////////
//DeRap: FS_2\1_Char\Lebedev\config.bin
...
class CfgVehicles
{
	...
	class FS_Saharov;
	class FS_ClearSky_Levedev_Char: FS_Saharov
	{
		scope = 2;
		
	};
	class FS_ClearSky_LevedevShapka_Char: FS_Saharov
	{
		scope = 2;
		
	};
	class FS_ClearSky_LevedevShapkaDMB_Char: FS_Saharov
	{
		scope = 2;
