////////////////////////////////////////////////////////////////////
//DeRap: FS_3\Weapons\Gitara\anekdot\config.bin
...
{
	class FNX45;
	class FS_AnekdotsSound_Base: FNX45
	{
		scope = 0;
		weight = 1500;
		absorbency = 0;
	...
	class FS_AnekdotsSound_Stalker: FS_AnekdotsSound_Base
	{
		scope = 2;
		displayName = "Collection of Anecdotes Stalkers";
		descriptionShort = "Launch a Stream of Jokes ----- Charge and Shoot ------------------- I do not advise you to start playing in one place very often. The sound will be dubbed.";
		...
		class Single: Mode_SemiAuto
		{
			soundSetShot[] = {"FS_AnekdotStalker_Soundset"};
			soundSetShotExt[] = {{"IZH18_silencerHomeMade_SoundSet","IZH18_silencerHomeMadeTail_SoundSet","IZH18_silencerInteriorHomeMadeTail_SoundSet"}};
	...
	class FS_AnekdotsSound_Bandit: FS_AnekdotsSound_Base
	{
		scope = 2;
		displayName = "Collection of Jokes Bandits";
		descriptionShort = "Launch a Stream of Jokes ----- Charge and Shoot ------------------- I do not advise you to start playing in one place very often. The sound will be dubbed.";
		...
		class Single: Mode_SemiAuto
		{
			soundSetShot[] = {"FS_AnekdotBandit_Soundset"};
			soundSetShotExt[] = {{"IZH18_silencerHomeMade_SoundSet","IZH18_silencerHomeMadeTail_SoundSet","IZH18_silencerInteriorHomeMadeTail_SoundSet"}};
			begin1[] = {"dz\sounds\weapons\shotguns\Izh43\izh43_close_0",1.77828,1,1000};
			begin2[] = {"dz\sounds\weapons\shotguns\Izh43\izh43_close_1",1.77828,1,1000};
			begin3[] = {"dz\sounds\weapons\shotguns\Izh43\izh43_close_2",1.77828,1,1000};
	...
	class FS_AnekdotsSound_Svoboda: FS_AnekdotsSound_Base
	{
		scope = 2;
		displayName = "Collection of Jokes Freedom";
		descriptionShort = "Start the Stream of Jokes ---- Charge and Shoot -------------------- I do not advise you to start playing in one place very often. The sound will be dubbed.";
		...
		class Single: Mode_SemiAuto
		{
			soundSetShot[] = {"FS_AnekdotSvoboda_Soundset"};
			soundSetShotExt[] = {{"IZH18_silencerHomeMade_SoundSet","IZH18_silencerHomeMadeTail_SoundSet","IZH18_silencerInteriorHomeMadeTail_SoundSet"}};
			begin1[] = {"dz\sounds\weapons\shotguns\Izh43\izh43_close_0",1.77828,1,1000};
			begin2[] = {"dz\sounds\weapons\shotguns\Izh43\izh43_close_1",1.77828,1,1000};
			begin3[] = {"dz\sounds\weapons\shotguns\Izh43\izh43_close_2",1.77828,1,1000};
	...
	class FS_AnekdotsSound_Army: FS_AnekdotsSound_Base
	{
		scope = 2;
		displayName = "Collection of Military Jokes";
		descriptionShort = "Launch a Stream of Jokes - Charge and Shoot -------------------- I do not advise you to start playing in one place very often. The sound will be dubbed. ";
		...
		class Single: Mode_SemiAuto
		{
			soundSetShot[] = {"FS_AnekdotVoen_Soundset"};
			soundSetShotExt[] = {{"IZH18_silencerHomeMade_SoundSet","IZH18_silencerHomeMadeTail_SoundSet","IZH18_silencerInteriorHomeMadeTail_SoundSet"}};
			begin1[] = {"dz\sounds\weapons\shotguns\Izh43\izh43_close_0",1.77828,1,1000};
			begin2[] = {"dz\sounds\weapons\shotguns\Izh43\izh43_close_1",1.77828,1,1000};
			begin3[] = {"dz\sounds\weapons\shotguns\Izh43\izh43_close_2",1.77828,1,1000};
