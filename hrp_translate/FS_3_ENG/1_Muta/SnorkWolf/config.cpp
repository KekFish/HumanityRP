...
class CfgVehicles
{
	...
	class FS_SnorkW_base: AnimalBase
	{
		...
		displayName = "SNORK";
		descriptionShort = "The Snork is a horrifically mutated human soldier or Stalker, still wearing tattered remains of his uniform, boots and a GP-4 gas mask with cracked eyepieces, and a flailing hose. ... Snorks were first encountered on May 22, 2007, near one of the army posts at the 30th kilometer of the Zone, on the Kharkov side.";
