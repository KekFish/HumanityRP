////////////////////////////////////////////////////////////////////
//DeRap: FS_3\1_Muta\MonolitZMB\config.bin
...
class CfgVehicles
{
	...
	class FS_MONOLIT_ZMB_Base: ZombieMaleBase
	{
		scope = 0;
		hiddenSelections[] = {"vkComFidovPublic2"};
		
		displayName = "Monolith fanatic";
		descriptionShort = "The Monolith is a religious cult, hostile to all but their own, which serves as a major antagonistic group";
		class DamageSystem
		{
			class GlobalHealth
			{
		...
		class AnimEvents
		{
			...
			class SoundVoice
			{
				class LightHit
				{
					soundSet = "FS_MONOLITzmb_Popal_Soundset";
					id = 1;
				};
				class HeavyHit
				{
				...
				class Attack
				{
					soundSet = "FS_MONOLITzmb_ATTACK_Soundset";
					id = 5;
				};
				class Jump
				{
				...
				{
					soundSet = "FS_MONOLITzmb_AGR_Soundset";
					id = 20;
				};
			};
		};
	};
	class FS_MONOLIT_ZMB: FS_MONOLIT_ZMB_Base
	{
		scope = 2;
