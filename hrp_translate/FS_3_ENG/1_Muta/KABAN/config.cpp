////////////////////////////////////////////////////////////////////
//DeRap: FS_3\1_Muta\KABAN\config.bin
...
{
	class AnimalBase;
	class FS_Kaban_base: AnimalBase
	{
		simulation = "dayzanimal";
		scope = 0;
		
		displayName = "Mutant Boar";
		descriptionShort = "Mutant Boar";
	...
	class FS_Kaban_black: FS_Kaban_base
	{
		scope = 2;
