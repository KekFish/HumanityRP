////////////////////////////////////////////////////////////////////
//DeRap: FS_4\1_ai\Cvetok\config.bin
...
class CfgVehicles
{
	...
	class FS_Saharov;
	class FS_Cvetok_BASE: ZombieMaleBase
	{
		scope = 0;
	...
	class FS_Cvetok_standart: FS_Cvetok_BASE
	{
		scope = 2;
		
	};
	class FS_Cvetok_green: FS_Cvetok_BASE
	{
		scope = 2;
