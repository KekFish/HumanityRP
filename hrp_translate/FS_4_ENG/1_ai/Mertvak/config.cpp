////////////////////////////////////////////////////////////////////
//DeRap: FS_4\1_ai\Mertvak\config.bin
...
class CfgVehicles
{
	...
	class FS_Saharov;
	class FS_Mertvak_BASE: ZombieMaleBase
	{
		scope = 0;
		...
		mFact = 5555;
		tBody = 5555;
		displayName = "Dead man";
		descriptionShort = "Incomprehensible fuck fuck her fuck her fuck";
		class Cargo
		{
	...
	class FS_Mertvak: FS_Mertvak_BASE
	{
		scope = 2;
