...
class cfgWeapons
{
	...
	class FS_SG550: FS_sg550_Base
	{
		scope = 2;
		displayName = "SIG SG 550 ";
		descriptionShort = "SIG SG 510 / Swiss machine gun developed in 1979-1980 based on the SIG SG 540 to replace the outdated automatic rifle SIG SG 510 by FIDOv";
