////////////////////////////////////////////////////////////////////
//DeRap: FV_ST_PACK\1_Weapons\ak12\config.bin
...
class cfgWeapons
{
	...
	class FS_AK12_Base: AKM
	{
		...
		magazines[] = {"FS_Mag_AK12_30rnd","Mag_AK74_30Rnd","Mag_AK74_30Rnd_Black","Mag_AK74_30Rnd_Green"};
	...
	class FS_ak12: FS_AK12_Base
	{
		scope = 2;
		displayName = "AK 12";
		descriptionShort = "Автомат Калашникова образца 2012 года. Опытный образец создан концерном «Калашников» в 2011 году и представлен публике в январе 2012. Представлял собой принципиально новый автомат реализованный с использованием общей схемы и технических решений прежних АК. После неудачи проекта на испытаниях по программе Ратник в 2016 году под тем же названием предложен гораздо более традиционный автомат, представляющий собой развитие темы сотой серии с полным перепроектированием в цифре и использованием некоторых технологических наработок от опытного АК-12";
		
		attachments[] = {"weaponOptics","weaponButtstockM4","weaponWrap","weaponMuzzleAK"};
		itemSize[] = {8,3};
	...
	class FS_ak12_Tactical: FS_AK12t_Base
	{
		scope = 2;
		displayName = "AK 12";
		descriptionShort = "Kalashnikov assault rifle"; 
