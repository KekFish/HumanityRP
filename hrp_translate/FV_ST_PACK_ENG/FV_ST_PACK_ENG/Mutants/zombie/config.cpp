////////////////////////////////////////////////////////////////////
//DeRap: FV_ST_PACK\Mutants\zombie\config.bin
//Produced from mikero's Dos Tools Dll version 7.46
//https://bytex.market/products/item/weodpphdknnzm70o0h8q/Mikero%27s%20Dos%20Tools
//'now' is Wed Aug 12 00:05:04 2020 : 'file' last modified on Tue Jun 02 00:10:29 2020
////////////////////////////////////////////////////////////////////
...
class CfgVehicles
{
	...
	class FS_Saharov;
	class FS_Zombie_Surv: FS_Saharov
	{
		scope = 2;
		
	};
	class FS_Zombie_Base: ZombieMaleBase
	{
		scope = 0;
	...
	class FS_Zombie_1: FS_Zombie_Base
	{
		scope = 2;
		
	};
	class FS_Zombie_2: FS_Zombie_Base
	{
		scope = 2;
		
	};
	class FS_Zombie_3: FS_Zombie_Base
	{
		scope = 2;
		
	};
	class FS_Zombie_4: FS_Zombie_Base
	{
		scope = 2;
		
	};
	class FS_Zombie_5: FS_Zombie_Base
	{
		scope = 2;
		
	};
	class FS_Zombie_6: FS_Zombie_Base
	{
		scope = 2;
		
	};
	class FS_Zombie_7: FS_Zombie_Base
	{
		scope = 2;
		
	};
	class FS_Zombie_8: FS_Zombie_Base
	{
		scope = 2;
		
	};
	class FS_Zombie_9: FS_Zombie_Base
	{
		scope = 2;
		
	};
	class FS_Zombie_10: FS_Zombie_Base
	{
		scope = 2;
		
	};
	class FS_Zombie_11: FS_Zombie_Base
	{
		scope = 2;
		
	};
	class FS_Zombie_12: FS_Zombie_Base
	{
		scope = 2;
		
	};
	class FS_Zombie_13: FS_Zombie_Base
	{
		scope = 2;
		
	};
	class FS_Zombie_14: FS_Zombie_Base
	{
		scope = 2;
		
	};
	class FS_Zombie_15: FS_Zombie_Base
	{
		scope = 2;
