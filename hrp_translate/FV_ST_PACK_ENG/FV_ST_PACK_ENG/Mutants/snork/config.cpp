////////////////////////////////////////////////////////////////////
//DeRap: FV_ST_PACK\Mutants\snork\config.bin
//Produced from mikero's Dos Tools Dll version 7.46
//https://bytex.market/products/item/weodpphdknnzm70o0h8q/Mikero%27s%20Dos%20Tools
//'now' is Wed Aug 12 00:05:02 2020 : 'file' last modified on Tue Jun 02 00:10:29 2020
////////////////////////////////////////////////////////////////////
...
class CfgVehicles
{
	...
	class FS_Saharov;
	class FS_Snork_Surv: FS_Saharov
	{
		scope = 2;
		
	};
	class FS_snork_Base: ZombieMaleBase
	{
		scope = 0;
		...
		class AnimEvents
		{
			...
			class SoundVoice
			{
				class LightHit
				{
					soundSet = "FV_ST_PACK_Snork_Popal_Soundset";
					id = 1;
				};
				class HeavyHit
				{
	...
	class FS_Snork: FS_snork_Base
	{
		scope = 2;
		
	};
	class FS_Snork_Boss: FS_snork_Base
	{
		scope = 2;
		hiddenSelections[] = {""};
		
		
		displayName = "Snork-unsuccessful experiment";
		descriptionShort = "What are you? ";
		};
};
