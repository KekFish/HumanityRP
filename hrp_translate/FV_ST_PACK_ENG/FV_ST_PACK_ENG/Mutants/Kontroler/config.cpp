////////////////////////////////////////////////////////////////////
//DeRap: FV_ST_PACK\Mutants\Kontroler\config.bin
//Produced from mikero's Dos Tools Dll version 7.46
//https://bytex.market/products/item/weodpphdknnzm70o0h8q/Mikero%27s%20Dos%20Tools
//'now' is Wed Aug 12 00:04:58 2020 : 'file' last modified on Tue Jun 02 00:10:29 2020
////////////////////////////////////////////////////////////////////
...
class CfgVehicles
{
	...
	class FS_Kontroler_Base: ZombieMaleBase
	{
		scope = 0;
		...
		class AnimEvents
		{
			...
			class SoundVoice
			{
				class LightHit
				{
					soundSet = "FV_ST_PACK_Kontrol_Popal_Soundset";
					id = 1;
				};
				class HeavyHit
				{
				...
				class Attack
				{
					soundSet = "FV_ST_PACK_KontrolAttack_Soundset";
					id = 5;
				};
				class Jump
				{
				...
				{
					soundSet = "FV_ST_PACK_Kontrol_AGGR_Soundset";
					id = 20;
				};
			};
		};
	...
	class FS_Kontroler: FS_Kontroler_Base
	{
		scope = 2;
		displayName = "Controller";
	...
	class FS_Kontroler_2: FS_Kontroler_Base
	{
		scope = 2;
		displayName = "Controller";
		descriptionShort = "Infected";
