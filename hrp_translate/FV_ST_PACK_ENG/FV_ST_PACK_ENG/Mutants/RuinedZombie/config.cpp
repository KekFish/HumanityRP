////////////////////////////////////////////////////////////////////
//DeRap: FV_ST_PACK\Mutants\RuinedZombie\config.bin
...
class CfgVehicles
{
	...
	class FS_Saharov;
	class FS_RuinedZMB_Base: ZombieMaleBase
	{
		scope = 0;
		hiddenSelections[] = {"vkComFidovPublicс"};
	...
	class FS_RuinedZMB: FS_RuinedZMB_Base
	{
		scope = 2;
