////////////////////////////////////////////////////////////////////
//DeRap: FV_ST_PACK\1_Smot\kgb\config.bin
...
class CfgVehicles
{
	...
	class FS_KGB_ColorBase: RadarCap_Black
	{
		displayName = "Soviet cap";
		descriptionShort = "Soviet cap with a red star";
	...
	class FS_Soviet_cap: FS_KGB_ColorBase
	{
		scope = 2;
