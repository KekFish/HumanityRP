class RepairGasMask_Filter extends RecipeBase	
{	
	override void Init()
	{
		m_Name = "Uzupełnij filtr do maski gazowej";
		...
		InsertIngredient(0,"hrp_GasMask_Filter");	
		...
		//result1
		AddResult("hrp_GasMask_Filter");//add results here
