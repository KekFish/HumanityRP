class CraftLeatherStorageVest extends RecipeBase
{
	override void Init()
	{
		m_Name = "#str_craftleathervest0";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		m_AnimationLength = 9.0;//animation length in relative time units
		...
		//result1
		AddResult("LeatherStorageVest_Black");//add results here
