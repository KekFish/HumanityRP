class CraftVodka extends RecipeBase	
{
	override void Init()
	{
		m_Name = "Wytwórz Wódeczke";
		...
		InsertIngredient(0,"FS_ITEM_VODKA");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"KKCR_PotatoSliced");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("Vodka");//add results here
