modded class LoadingScreen
{
	...
	ImageWidget Loading_aod;
	ImageWidget ImageBackground;
	...
	void LoadingScreen(DayZGame game)
	{
		...
		m_WidgetRoot = game.GetLoadingWorkspace().CreateWidgets("HumanityRP/hrp_gui/gui/layouts/loading.layout");
		...
		Class.CastTo(ImageBackground, m_WidgetRoot.FindAnyWidget("ImageBackground"));
		Class.CastTo(m_ImageLoadingIcon, m_WidgetRoot.FindAnyWidget("ImageLoadingIcon"));

		ImageBackground = ImageWidget.Cast(m_WidgetRoot.FindAnyWidget("ImageBackground"));
